...
/**
 * Test Co-Authors Plus' template tags.
 */
class Test_Template_Tags extends CoAuthorsPlus_TestCase {

	/**
	 * Set up for tests. Define filters and create users.
	 */
	...
	public function test_coauthors_wp_list_authors_for_optioncount() {
		...
		$this->assertContains(
			'(' . count_user_posts( $this->author1->ID ) . ')', coauthors_wp_list_authors(
				array(
					'echo'        => false,
					'optioncount' => true,
				)
	...
	public function test_coauthors_wp_list_authors_for_hide_empty() {
		...
		$this->assertContains(
			'author2', coauthors_wp_list_authors(
				array(
					'echo'       => false,
					'hide_empty' => false,
				)
